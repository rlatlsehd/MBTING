    ...
    <body id="page-top">
        ...
        <section class="page-section" id="services">
            <div class="container">
      		 ...
      		 <img src="resources/assets/img/debate/debate.png" class="d-block w-100" alt="resources/img/undraw_profile_1.svg">
    
     <div class="container px-5">
     <iframe src="//uchat.ch/mbting" style="display:inline-block; width:1300px; height:500px;" frameborder=0></iframe>
     </div>
      <br>
      	<br>
