...
<%@ page language="java" contentType="text/html; charset=UTF-8"    pageEncoding="UTF-8"%>
    ...
    <body id="page-top">
      ...
      <img src="resources/assets/img/service/service.png" class="d-block w-100" alt="MBTING이란?">

      <img src="resources/assets/img/serviceCenter/service2.png" class="d-block w-100" alt="mbti 정보">
    
      <img src="resources/assets/img/serviceCenter/service3.png" class="d-block w-100" alt="게시판 설명">
   
      <img src="resources/assets/img/serviceCenter/service4.png" class="d-block w-100" alt="mbting 토크">
 ...
 <div class="col-12 company-info" >
            ...
            <div class="col-12" style="padding: 0; margin-top: 24px; padding-left: 300px;">
               <h4>  (주)공수레</h4>
            </div>   
      ...
      <h3> <li class="jg" > 대표 : 김신동,김선민,강유리,김대운,김정우</li></h3><br/>   
              ...
              <h6>  화물운송주선사업자 : 제 123호<br/></h6>
            <h6>    통신판매업신고 : 2019-부산남구-0519<br/></h6>
