...
<%@ page language="java" contentType="text/html; charset=UTF-8"    pageEncoding="UTF-8"%>
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <a class="btn btn-primary btn-xl text-uppercase" href="<%=request.getContextPath()%>/serviceIntroduction.do">지금 시작하기</a>
            </div>
        </header>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Service introduction</h3>
                </div>
                                
       <!--메인 이미지 1은 css 11409 -->        
      <img src="resources/assets/img/main/main2.png" class="d-block w-100" alt="백셔틀이란?">

      <img src="resources/assets/img/main/main3.png" class="d-block w-100" alt="공차걱정 no">
    
      <img src="resources/assets/img/main/main4.png" class="d-block w-100" alt="함께하는 용달 생활">
   
      <img src="resources/assets/img/main/main5.png" class="d-block w-100" alt="매너기름">
